...
* Notes: My functions run really slow on my desktop, yet finishes running really fast on the laptop for reasons I am unaware of, so it might take some time to finish executing.
